...
import { Smile, Frown, Zap, Coffee, Heart, Battery, Brain, PartyPopper, Target } from "lucide-react";
...
const emotions: EmotionOption[] = [
  ...
  { name: "Bored", icon: <Coffee className="w-6 h-6" />, color: "bg-gray-100 hover:bg-gray-200" },
